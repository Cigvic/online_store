...
const ShopInfo = (props) => {
  return (
    <div className={'ShopInfo ' + props.mix} onMouseLeave={() => props.onMouseLeave(false)}>
        <div className='ShopInfo__working-time'>
          ...
          <div className='ShopInfo__text-block'>
            <p className='ShopInfo__paragraph ShopInfo__paragraph_first-row'>We are open:</p>
            <p className='ShopInfo__info-text'><span className='ShopInfo__grey-text'>Mon-Thu:</span>  9:00 AM - 5:30 PM</p>
            <p className='ShopInfo__info-text'><span className='ShopInfo__grey-text'>Fr:</span>  9:00 AM - 6:00 PM</p>
            <p className='ShopInfo__info-text'><span className='ShopInfo__grey-text'>Sat:</span>  11:00 AM - 5:00 PM</p>
          </div>
          </div>
          <div className='ShopInfo__address'>
            ...
            <p className='ShopInfo__paragraph'>Address: 1234 Street Adress, City Address, 1234</p>
          </div>
          <div className='ShopInfo__phone'>
            <p className='ShopInfo__paragraph'>Phones: (00) 1234 5678</p>
            <p className='ShopInfo__paragraph'>E-mail: <a href="mailto:shop@email.com">shop@email.com</a></p>
          </div>
    </div>
  );
};
