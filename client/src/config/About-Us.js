const sliderData = [
  {
    theme: 'dark',
    config: {
      header: 'A Family That Keeps On Growing',
      ...
      img: {
        src: 'https://thumb.cloud.mail.ru/weblink/thumb/xw1/95Do/K8RXSmJac',
        alt: 'Our store'
      }
    }
  },
  {
    ...
    config: {
      ...
      img: {
        src: 'https://thumb.cloud.mail.ru/weblink/thumb/xw1/crU6/df6D6FAG9',
        alt: 'Keyboard'
      }
    }
  },
  {
    ...
    config: {
      ...
      img: {
        src: 'https://thumb.cloud.mail.ru/weblink/thumb/xw1/BSQ3/o8udM8LRp',
        alt: 'Cool green computer'
      }
    }
  },
  {
    theme: 'light',
    config: {
      header: 'The Highest Quality of Products',
      ...
      img: {
        src: 'https://thumb.cloud.mail.ru/weblink/thumb/xw1/xYaf/ioafotMtm',
        alt: 'Cool white computer'
      }
    }
  },
  {
    theme: 'dark',
    config: {
      header: 'Delivery to All Regions',
      ...
      img: {
        src: 'https://thumb.cloud.mail.ru/weblink/thumb/xw1/eEpT/i33kzALP9',
        alt: 'Cool gray computer'
      }
    }
  }
];
